...
const AddPipeline = () => {
    ...
    const handleCloseDialog = () => {
        ...
        setSelectedOption(""); //resets the selected option upon closing the dialog
    }
                    ...
                    <SheetHeader>
                        <div className="flex justify-between">
                            <div className="flex justify-start">
                                <SheetTitle className="flex items-center text-gray-700 font-bold text-xl">
                                    <img className="mx-4" width={36} src="./ctrlsvg.svg" />
                                    Ctrlb
                                </SheetTitle>
                            </div>
